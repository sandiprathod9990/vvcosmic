...
module.exports = {
  ...
  seo: {
    ...
    booking: {
      ...
      description:
        'Submit a private consultation inquiry to VVCosmic. Share your context for pattern observation and alignment advisory with Harshil Sevak.',
      keywords: 'VVCosmic inquiry, Harshil Sevak consultation',
    },
  },

  practiceDomains: [
    { id: 'astrology', slug: 'astrology', name: 'Astrology', description: '' },
    { id: 'spatial-intelligence', slug: 'vastu', name: 'Spatial Intelligence', description: '' },
  ],
